...
const LoginPage = () => {
    ...
    return (
        <main className="bg-[#F7F9FA] w-full min-h-screen flex justify-center items-center">
            <div className="max-w-136 w-full bg-white rounded-xl border-t-4 border-primary p-12 px-18">
                <Image src="/images/logoAdmin.svg" alt="logo admin"
                width={304} height={51} 
                ...
                {errorMessage && (
                    <div className="px-3 py-1 bg-primary-light border mb-2 border-primary rounded md text-sm text-center w-full">
                        {errorMessage}
                    </div>
                )}
