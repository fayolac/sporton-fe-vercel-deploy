...
const HeroSection = () => {
    ...
    <div className="relative self-center">
        ...
        />
        <div className="relative ml-40 w-full py-20">
            <div className="text-primary italic ">Friday Sale 50%</div>
            <h1 className="font-extrabold text-[95px] italic bg-gradient-to-b leading-tight from-black to-[#979797] bg-clip-text text-transparent">WEAR YOUR <br/> TOP-QUALITY <br/>SPORTSWEAR 
            </h1>
