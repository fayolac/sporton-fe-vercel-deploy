...
const ImageUploadPreview = ({label, value, onChange, className}: TImageUploadPreviewProps) => {
    ...
    return (
        <div className={className}>
            <div onClick={handleImageClick} className="border-2 border-dashed border-primary bg-primary/5 rounded-lg 
            h-50 flex flex-col justify-center items-center">
                {
                    value ? (
                        <div className="max-w-47.5 relative">
                            <Image src={value} width={190} height={190}
                             alt="preview product" className="w-full h-full object-cover"/>
