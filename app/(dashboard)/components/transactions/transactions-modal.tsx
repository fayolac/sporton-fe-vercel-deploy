...
const TransactionsModal = ({isOpen, onClose} : TTransactionModalProps) => {
        ...
        title="Verify Transactions">
            <div className="flex gap-6">
                <div>
                    ...
                    <Image src="/images/receipt-proof.svg" 
                ...
                <div>
                    <div>
                        ...
                        <div className="bg-gray-100 rounded-md flex flex-col gap-2.5 p-4 text-sm mb-5">
                            ...
                            <div className="flex justify-between font-medium gap-10">
                                ...
                                <div className="text-right">Merdeka Stress, Jakarta, Indonesia, 332122</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-2 flex items-center gap-2">
                        <div className="bg-gray-100 rounded aspect-square w-8 h-8">
                            <Image src="/images/products/product-1.svg"
