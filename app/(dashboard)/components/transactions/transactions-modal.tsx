    ...
    return (
        ...
        <div className="flex gap-6">
            ...
            {transaction.paymentProof ? (
                <Image src={getImageUrl(transaction.paymentProof)}
            ...
            <div className="space-y-3">
                {transaction.purchasedItems.map((item) => (
                    <div className="border border-gray-200 rounded-lg p-2 flex items-center gap-2">
                        ...
                        <Image src={getImageUrl(item.productId.imageUrl)}
                            width={30} height={30}alt="product image"
                        />
                        </div>
            ...
            <div className=" flex justify-end gap-5 mt-12">
                {isUpdating ? (
                    ...
                    <>
                        <Button
                        className="text-primary! bg-primary-light! rounded-md" size="small" 
                        onClick={() => handleStatusUpdate("rejected")} disabled={isUpdating} >
                            <FiX size={20} />
                                Reject
                        </Button>
                        <Button
                        className="text-white! bg-[#50C252]! rounded-md" size="small"
                        onClick={() => handleStatusUpdate("paid")} disabled={isUpdating}>
                            <FiCheck size={20} />
                                Approve
                        </Button>
                    </>
